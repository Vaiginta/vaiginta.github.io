...
class Demo {
  ...
  createTexture() {
    var self = this;
      ...
      var flippedTexture = new THREE.TextureLoader().load('cat.jpg');
      ...
      var texture2 = new THREE.TextureLoader().load('cat.jpg');
      ...
      var flippedTexture2 = new THREE.TextureLoader().load('cat.jpg');
